...
const style = {
	...
	rounded-lg mr-5 text-white hover:bg-[#42a0ff] cursor-pointer`,
	button: ` relative text-lg font-semibold px-12 py-4 bg-[#363840] 
	rounded-lg mr-5 text-[#e4e8ea] hover:bg-[#4c505c] cursor-pointer`,
...
const Hero = () => {
	return <div className={style.wrapper}>
		<div className={style.container}>
            ...
            OpenSea is the word&apos;s first and largest NTF marketplace
					</div>
